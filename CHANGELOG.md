...
Creed products follow [Semantic Versioning](https://semver.org/). Commits record work; versions and Git tags mark deliberate product releases. A commit landing on `main` does not automatically advance Open, Cloud, CLI, or Status.
