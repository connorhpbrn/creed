...
//
// Shared: proposal review. Owner/admin may review any; a member may review
...
export async function POST(request: Request, ctx: Ctx) {
  ...
  // Personal-vs-shared dispatch: creed-membership owns the ownership
  // semantics. A creedId that is the caller's own personal Creed goes down
  // the personal path; anything else (a shared, or someone else's personal
  // Creed) goes through reviewSharedProposal, whose role check rejects
  // non-members.
