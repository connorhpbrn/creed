...
Creed is a small, open-source codebase. Main application source paths below
are relative to `apps/creed/`. The pieces most worth scrutinising:
...
4. Apply every migration in `apps/creed/supabase/migrations/` before opening
