// Standalone Creed glyph (the square mark from the brandmark). Uses
// currentColor so it follows the text colour: near-black in light, off-white
// in dark — matching how creed.md renders the wordmark across themes.
